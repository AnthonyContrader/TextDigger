...
import com.contrader.textdigger.repository.LibraryRepository;
import com.contrader.textdigger.service.LibraryService;
import com.contrader.textdigger.service.dto.LibraryDTO;
import com.contrader.textdigger.service.mapper.LibraryMapper;
...
public class LibraryResourceIT {
    ...
    public void createLibrary() throws Exception {
        ...
        assertThat(testLibrary.getLibraryName()).isEqualTo(DEFAULT_LIBRARY_NAME);
    }
    ...
    public void updateLibrary() throws Exception {
        ...
        Library testLibrary = libraryList.get(libraryList.size() - 1);
        assertThat(testLibrary.getLibraryName()).isEqualTo(UPDATED_LIBRARY_NAME);
    }
