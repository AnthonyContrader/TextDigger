 ...
 * @author Vittorio
 * 
 * Implementando questa l'interfaccia converter la classe TagConverter ? OBBLIGATA ad implementarne i metodi
 *
 */
public class TagConverter  implements Converter<Tag, TagDTO> {
	...
	public TagDTO toDTO(Tag tag) {
		TagDTO tagDTO = new TagDTO(tag.getId(), tag.getTag());
		return tagDTO;
	}
	...
	public Tag toEntity(TagDTO tagDTO) {
		Tag tag = new Tag(tagDTO.getId(), tagDTO.getTag());
		return tag;
	}
