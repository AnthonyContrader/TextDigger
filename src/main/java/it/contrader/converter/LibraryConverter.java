...
public class LibraryConverter extends AbstractConverter<Library, LibraryDTO> {
	...
	public Library toEntity(LibraryDTO libraryDto) {
		...
		if(libraryDto != null) {
			library = new Library(libraryDto.getId(), libraryDto.getName(), libraryDto.getDescription(),
	...
	public LibraryDTO toDTO(Library library) {
		...
		if(library != null) {
			libraryDTO = new LibraryDTO(library.getId(), library.getName(), library.getDescription(),
					library.getInterest());
		}
		return libraryDTO;
	}
